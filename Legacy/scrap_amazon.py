...
urlBase = 'https://www.amazon.es/s?k='  #flow+my+tears&__mk_es_ES=ÅMÅŽÕÑ&ref=nb_sb_noss_1'
...
print("IMAGE")
print("-" * 80)
for level1 in bsObj.findAll('div', {"id": "img-canvas"}):
	pprint.pprint(level1.attrs)
	for level2 in level1.findAll('img'):
		#print("img")
		pprint.pprint(level2.attrs['data-a-dynamic-image'])
